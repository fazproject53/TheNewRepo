...
Widget drowFolldingCell(key,double height,Widget frontWidget,Widget innerWidget,{double left=15,double right=15,double top=15,double bottom=15}){
return SimpleFoldingCell.create(
          key: key,
          frontWidget: frontWidget,
          innerWidget: innerWidget,
          cellSize: Size(double.infinity, height.h),
