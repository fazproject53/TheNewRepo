...
//كوميديا----------------------------------------------------------
           Padding(
             ...
             child: Align(alignment:Alignment.centerRight,child: text(context, "كوميديا", 18, black,fontWeight: FontWeight.bold)),
           ),
                ...
                SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: catogary("كوميديا", "مروان بابلو", "assets/image/comp.jpg"),
                    )),
                    SizedBox(
                  height: 15.h,
                ),
...
//رياضي----------------------------------------------------------
           Padding(
             padding:  EdgeInsets.only(right: 18.w,left:18.w),
             child: Align(alignment:Alignment.centerRight,child: text(context, "رياضة", 18, black,fontWeight: FontWeight.bold)),
           ),
                ...
                SizedBox(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(8.0.h),
                      child: catogary("رياضة", "مروان بابلو", "assets/image/sport.jpg"),
                    )),
                    SizedBox(
                  height: 15.h,
                ),
...
//اطفال----------------------------------------------------------
           Padding(
             padding:  EdgeInsets.only(right: 18.w,left:18.w),
             child: Align(alignment:Alignment.centerRight,child: text(context, "اطفال", 18, black,fontWeight: FontWeight.bold)),
           ),
                ...
                SizedBox(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(8.0.h),
                      child: catogary("اطفال", "مروان بابلو", "assets/image/child.jpg"),
                    )),
                    SizedBox(
                  height: 15.h,
                ),
...
//سياحة----------------------------------------------------------
           Padding(
             padding:  EdgeInsets.only(right: 18.w,left:18.w),
             child: Align(alignment:Alignment.centerRight,child: text(context, "سياحة", 18, black,fontWeight: FontWeight.bold)),
           ),
                ...
                SizedBox(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(8.0.h),
                      child: catogary("كوميديا", "مروان بابلو", "assets/image/cult.jpg"),
                    )),
                    SizedBox(
                  height: 15.h,
                ),
...
//مطربين----------------------------------------------------------
           Padding(
             padding:  EdgeInsets.only(right: 18.w,left:18.w),
             child: Align(alignment:Alignment.centerRight,child: text(context, "مطربين", 18, black,fontWeight: FontWeight.bold)),
           ),
                ...
                SizedBox(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(8.0.h),
                      child: catogary("كوميديا", "مروان بابلو", "assets/image/singer.jpg"),
                    )),
                    SizedBox(
                  height: 15.h,
                ),
...
//-catogary-------------------------------------------------------------------
  ...
  jouinFaums() {
    gradientContainerNoborder(184.5, Column(
                            children: [
