...
//كوميديا----------------------------------------------------------
                SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: catogary("", "", "assets/image/celebrityimg.png"),
                    )),
              ],
            ),
          )),
...
//-catogary-------------------------------------------------------------------
   catogary(String catoName, String famusName, String famusImage) {
            ...
            return SizedBox(
              ...
              child: Card(
                ...
                child: Column(children: [
                  Container(decoration: decoration(famusImage),)
                ],),
              ),
            );
          }),
  ...
  BoxDecoration decoration(String famusImage) {
    return BoxDecoration(
      image:DecorationImage( image: AssetImage(famusImage),fit: BoxFit.cover,),
    );
  }
  //-------------------------------------------------------------
}
