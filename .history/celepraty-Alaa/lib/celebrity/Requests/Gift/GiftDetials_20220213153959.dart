...
//ad titel-----------------------------------------------------
        ...
        Container(
          ...
          width: double.infinity,
          height: 50.h,
          margin: EdgeInsets.only(left: 9.w, right: 15.w, bottom:0.w, top: 8.w),
          child: Align(
...
//description----------------------------------------------------------------------
        Container(
          ...
          width: double.infinity,
          height: 90.h,
          margin: EdgeInsets.only(left: 9.w, right: 15.w, bottom: 8.w),
          child: Align(
              ...
              child: Row(
                children: [
                  ...
                  text(
                    context,
              " اريد طلب اهداء بمناسبة${giftType[widget.i!]} xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
                    13,
                    deepgrey!,
                    fontWeight: FontWeight.bold,
                    align: TextAlign.justify,
