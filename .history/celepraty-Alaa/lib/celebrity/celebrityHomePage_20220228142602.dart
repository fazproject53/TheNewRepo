import 'package:celepraty/Models/Methods/classes/ClickGrantitContiner.dart';
...
//slider image---------------------------------------------------------
                      ...
                      Padding(
                        ...
                        child: Align(
                            ...
                            child: text(
                                context, "${textList[currentIndex]}", 30, black,
  ...
  Widget imageSlider() {
    return Swiper(
      ...
      control: SwiperControl(
          color: grey, padding: EdgeInsets.only(left: 15.w, right: 15.w)),
    );
  }
  ...
  Widget heroLogo() {
    return Row(mainAxisSize: MainAxisSize.min, children: [
      Padding(
        ...
        child: ClickedGradientIcon(Icons.add, 30, gradient(),onPressed:               showBottomSheett(context, bottomSheetMenue());
,),
      ),
