...
//اكسبلور صور بيكسل--------------------------------------------------------------
  ...
  Widget showButton(String utext, String image) {
   return Expanded(child: gradientContainerNoborder(105, Stack(
     children: [
      //  Align(
      ...
      //  ),
       Align(
         ...
         child:text(context, utext, 14, white,fontWeight: FontWeight.bold) ),
  ...
  Widget catogary(String catoName,String famusName,String famusImage) {
    return Expanded(child: ListView.builder(itemCount: 7,itemBuilder: (context,int itemPosition){
     return  SizedBox(
    width: 160.w,
    height: 196.h,
    child: Card(
